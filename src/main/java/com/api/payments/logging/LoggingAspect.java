package com.api.payments.logging;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.api.payments.controller.*.*(..)) || execution(* com.api.payments.services.*.*(..)) || execution(* com.api.payments.dao.*.*(..))")
	private void selectAll() {
	}

	@AfterReturning(pointcut = "execution(* com.api.payments.controller.*.*(..))", returning = "retVal")
	...
	@Pointcut("execution(* com.api.payments.controller.*.*(..))")
