...
@Document
public class CreatePaymentSubmissionP {
	...
	private PaymentSubmissionPOSTRequest body;
	...
	public CreatePaymentSubmissionP(){}

	public CreatePaymentSubmissionP(String xIdempotencyKey,String xFapiFinancialId,String authorization,PaymentSubmissionPOSTRequest body,String xFapiCustomerLastLoggedTime,String xFapiCustomerIpAddress,String xFapiInteractionId,String xJwsSignature){
	...
	public PaymentSubmissionPOSTRequest getBody() {
		 return body;
	}

	public void setBody(PaymentSubmissionPOSTRequest body) {
		 this.body=body;
	}
